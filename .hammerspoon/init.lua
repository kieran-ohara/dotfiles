...
hotkey.bind(hyper, 'I', function() application.launchOrFocus('Alacritty') end)
hotkey.bind(hyper, 'K', function() application.launchOrFocus('Kaleidoscope') end)
hotkey.bind(hyper, 'L', function() application.launchOrFocus('Lens') end)
...
hotkey.bind(hyper, 'Y', function() application.launchOrFocus('Sizzy') end)
