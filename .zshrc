...
# ZSH Settings. {{{
export PATH="$HOME/src/dotfiles/binary:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/opt/X11/bin:/Applications/MySQLWorkbench.app/Contents/MacOS:/Library/TeX/texbin"
